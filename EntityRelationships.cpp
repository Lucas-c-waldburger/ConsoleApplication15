...
void EntityRelations::SetParent(ComponentManager& componentManager, Entity_t entity, Entity_t requestedParent)
{
...
bool EntityRelations::AddChild(ComponentManager& componentManager, Entity_t entity, Entity_t requestedChild)
{
...
bool EntityRelations::RemoveChild(ComponentManager& componentManager, Entity_t entity, Entity_t requestedChild)
{
...
void EntityRelations::DestroyRelationshipsWithEntity(ComponentManager& componentManager, Entity_t entity)
{
    if (componentManager.HasComponent<Parent>(entity))
    {
