...
////};
//
////template <SomeCallbackDetails Details>
////struct CallbackKey
////{
...
//
//// 
////struct ControllerInputCallbackKey
////{
////	GameControllerInputSource source;
////};
//
//
////template <typename Derived, SomeCallbackKey Key, size_t N, typename...CallbackArgs>
////class BaseCallbackRegistry
////{
////public:
...
////	};
////
////	using CallbackType = fu2::unique_function<ReturnSignal(Entity_t, CallbackArgs...)>;
////
////	BaseCallbackRegistry() = default;
////	~BaseCallbackRegistry() = default;
////
////	BaseCallbackRegistry(const BaseCallbackRegistry&) = delete;
////	BaseCallbackRegistry& operator=(const BaseCallbackRegistry&) = delete;
////
////	BaseCallbackRegistry(BaseCallbackRegistry&& rhs) noexcept : masterTable_(std::move(rhs.masterTable_)) {}
////	BaseCallbackRegistry& operator=(BaseCallbackRegistry&& rhs) noexcept
////	{
////		if (this != &rhs)
////		{
...
////	{
////		return static_cast<Derived*>(this)->KeyRegisteredImpl(key);
////	}
////
////	template <typename Fn>
////	RegistrationOutcome RegisterCallback(std::string_view name, Fn&& fn, std::optional<Entity_t> owner)
////	{
////		return static_cast<Derived*>(this)->RegisterCallbackImpl(name, std::forward<Fn>(fn), owner);
////	}
////
////	template <typename Fn>
...
////
////protected:
////	std::array<std::unordered_map<Key, CallbackType>, N> masterTable_;
////};
//
//// TODO: MAKE SOMECALLBACKREGISTRY CONCEPT
//
////class EventCallbackRegistry;
////using EventCallbackRegistrySuper = BaseCallbackRegistry<EventCallbackRegistry, EventCallbackKey,
////													    EventDataTypeList::size, const Event&>;
//
//
//class EventCallbackRegistry
//{
...
//
//private:
//	// hash and eq dont include eventType so we can store multiple callbacks for the same type
//	struct KeyHash
//	{
