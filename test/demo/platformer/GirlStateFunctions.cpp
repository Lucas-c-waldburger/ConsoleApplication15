...
//}
//
//void HandleGirlAxisMovement(GirlStateContextOld& ctx, Entity& girl)
//{
...
//
//	ctx.flags |= GirlStateContextOld::Flag::PerformJumpPressedIntent;
//}
//
//void OnGirlJumpStateIntent(GirlStateContextOld& ctx, Entity& girl)
//{
//	if ((ctx.flags & GirlStateContextOld::Flag::PerformJumpPressedIntent) != 0)
//	{
...
//OnGirlJumpStateEval(GirlStateContextOld& ctx, Entity& girl)
//{
...
//}
//
//void OnGirlFallStateEnter(GirlStateContextOld&, Entity& girl)
//{
//	auto [anim, state, rigid] =
//		girl.GetComponents<SpriteAnimationComponent, GirlState, RigidBody>();
//
...
//
//GirlStateNode::EvaluationResponse
//OnGirlFallStateEval(GirlStateContextOld&, Entity& girl)
//{
...
//
//GirlStateNode::EvaluationResponse
//OnGirlIdleStateEval(GirlStateContextOld& ctx, Entity& girl)
//{
//	const auto [tf, state] = girl.GetComponents<Transform, GirlState>();
//
//	auto eval = GirlStateContextOld::Evaluate(girl, ctx);
//
//	if (!eval.onGround)
//	{
//		return GirlState::Animation::Falling;
//	}
//	if (eval.jumpPressed || 
//		(ctx.flags & GirlStateContextOld::PerformJumpPressedIntent))
//	{
//		return GirlState::Animation::Jumping;
//	}
...
//
//GirlStateNode::EvaluationResponse
//OnGirlWalkStateEval(GirlStateContextOld& ctx, Entity& girl)
//{
//	auto eval = GirlStateContextOld::Evaluate(girl, ctx);
//
//	if (!eval.onGround)
...
//
//	ctx.flags |= GirlStateContextOld::Flag::PerformLandingIntent;
//}
//
//GirlStateNode::EvaluationResponse
//OnGirlLandingStateEval(GirlStateContextOld& ctx, Entity& girl)
//{
...
//{
//	if ((ctx.flags & GirlStateContextOld::Flag::PerformLandingIntent) == 0)
//	{
//		return;
//	}
//
